...
class BillingAccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create billing_account" do
    assert_difference('BillingAccount.count') do
      post billing_accounts_url, params: { billing_account: { enabled: @billing_account.enabled, name: @billing_account.name, user_id: @billing_account.user_id } }
    end
  ...
  test "should update billing_account" do
    patch billing_account_url(@billing_account), params: { billing_account: { enabled: @billing_account.enabled, name: @billing_account.name, user_id: @billing_account.user_id } }
