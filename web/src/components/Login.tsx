    ...
    render() {
        ...
        return (
            <div id="login-container">
                <div className="inner">
                    <img style={{ display: 'block', maxWidth: '200px', margin: '0 auto 15px' }} src="/logo_square.png" alt="Money"/>
                    <FlashAlert />
                    <form onSubmit={this.logIn.bind(this)}>
                        ...
                        <button type="submit" disabled={this.state.buttonDisabled} className="btn btn-primary">Entrar</button>
                    </form>
                </div>
            </div>
        );
